...
class FirebaseProfileRepository implements ProfileRepository {
  ...
  Future<void> saveProfile(ProfileEntity profile) async {
    final User user = _currentUser();
    final ProfileModel profileModel = ProfileModel.fromEntity(profile);

    try {
      await _usersCollection.doc(user.uid).set(<String, dynamic>{
        ...profileModel.toMap(),
        FirestoreFields.updatedAt: FieldValue.serverTimestamp(),
        FirestoreFields.createdAt: profileModel.createdAt == null
            ? FieldValue.serverTimestamp()
            : Timestamp.fromDate(profileModel.createdAt!),
