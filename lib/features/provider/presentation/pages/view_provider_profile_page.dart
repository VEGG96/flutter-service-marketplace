...
class ViewProviderProfilePage extends StatelessWidget {
  ...
  const ViewProviderProfilePage({super.key, required this.providerId});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: <BoxShadow>[
          BoxShadow(
            color: Color.fromARGB((0.18 * 255).round(), 0, 0, 0),
            blurRadius: 20,
...
class _Pill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 6),
      decoration: BoxDecoration(
        color: Color.fromARGB((0.16 * 255).round(), 255, 255, 255),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: Color.fromARGB((0.2 * 255).round(), 255, 255, 255),
        ),
